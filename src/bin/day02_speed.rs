...
/*
We use the fact that each line (including the newline) consists of 4 bytes. We
add to the part1, part2 scores based on this lookup table:
...
entries in [0, 8) and thus fitting in 3 bits each packed inside a single u32.
*/
